...
# --- Problem directories ---
# PROBLEM_DIR="./Op_problems/problem_system_of_ode" # Put your problem directory
...
PROBLEM_DIR="Op_problems/problem_catalysis_dae"
PROBLEM_DIR="Op_problems/problem_gradient_testing"
